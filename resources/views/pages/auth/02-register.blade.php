    ...
    <section class="fixed inset-0 flex items-center justify-center px-4 sm:p-16">
        <div class="w-full max-w-lg bg-white rounded-lg shadow p-10 sm:p-16">
            ...
            <div class="text-center mb-6">
                <h1 class="text-2xl font-bold text-4 mb-1">Buat Akun</h1>
                <p class="text-base text-5">Daftar diri anda terlebih dahulu</p>
            </div>
            ...
            <p class="text-center text-sm text-grey mt-4">
                Sudah Memiliki Akun? <a href="{{ route('login') }}" class="text-cyan-700 font-semibold">Login</a>
            </p>
        </div>
    </section>
